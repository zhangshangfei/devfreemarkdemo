...
public class StringUtils extends org.springframework.util.StringUtils {
	...
	// 	return encoder.encodePassword(pwd, SpringContextHolder.getBean(Config.class).getSalt());
	// }
	//
	// public static String getDefaultPassword(){
	// 	String defaultPwd = SpringContextHolder.getBean(Config.class).getDefaultPassword();
	// 	return encodePwd(defaultPwd);
	// }
	 ...
	 * @return
	 */
	// public static boolean checkPassword(String originPwd,String encodedPwd){
	// 	if(StringUtils.isNotEmpty(originPwd) && StringUtils.isNotEmpty(encodedPwd) && encodePwd(originPwd).equals(encodedPwd)){
	// 		return true;
	// 	}
	// 	return false;
	// }
